...
func TestContainingPackage(t *testing.T) {
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/github.com/o2lab/go-tools/go/buildutil/util_test.go",
			"github.com/o2lab/go-tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/github.com/o2lab/go-tools/go/buildutil/util_test.go", "github.com/o2lab/go-tools/go/buildutil"},
			{tmp, gopath + "/src/github.com/o2lab/go-tools/go/buildutil/util_test.go", "github.com/o2lab/go-tools/go/buildutil"},
			{tmp, tmp + "/src/github.com/o2lab/go-tools/go/buildutil/util_test.go", "github.com/o2lab/go-tools/go/buildutil"},
		}...)
	}
