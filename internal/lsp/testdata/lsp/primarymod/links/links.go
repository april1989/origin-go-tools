...
import (
	...
	"github.com/o2lab/go-tools/internal/lsp/foo" //@link(`github.com/o2lab/go-tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/o2lab/go-tools/internal/lsp/foo`)
