...
import (
	...
	"github.com/o2lab/go-tools/internal/lsp/baz"
	_ "github.com/o2lab/go-tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)
