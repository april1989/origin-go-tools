...
// Options is github.com/o2lab/go-tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/o2lab/go-tools/imports.Process with explicit context in opt.Env.
